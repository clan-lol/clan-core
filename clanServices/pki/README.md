...
[`meta.domain`](/docs/reference/options/clan#domain) in
...
Services that export [`endpoints`](/docs/reference/options/clan_service/#exports)
...
The service reads [`endpoints`](/docs/reference/options/clan_service/#exports)
