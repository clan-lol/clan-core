...
[`meta.domain`](https://clan.lol/docs/unstable/reference/options/clan#domain) in
...
Services that export [`endpoints`](https://clan.lol/docs/unstable/reference/options/clan_service/#exports)
...
The service reads [`endpoints`](https://clan.lol/docs/unstable/reference/options/clan_service/#exports)
