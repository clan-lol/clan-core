{
  ...
  testScript =
    { nodes, ... }:
    let
      expectedPeer1Ip = nodes.peer1.clan.core.vars.generators.yggdrasil.files.address.value;
      expectedPeer2Ip = nodes.peer2.clan.core.vars.generators.yggdrasil.files.address.value;
      expectedOutsiderIp = nodes.outsider.clan.core.vars.generators.yggdrasil.files.address.value;
    in
    ''
      start_all()
      ...
      # Compare runtime addresses with expected addresses from generated vars
      expected_peer1_ip = "${expectedPeer1Ip}"
      expected_peer2_ip = "${expectedPeer2Ip}"
      expected_outsider_ip = "${expectedOutsiderIp}"
