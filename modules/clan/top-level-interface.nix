    ...
    clanInternals = lib.mkOption {
      ...
      type = types.submodule {
        ...
        options = {
          ...
          # Warnings & Errors to be printed by the cli
          cliChecks = lib.mkOption {
            type = types.listOf (
              types.submodule {
            ...
            default = [ ];
            description = "Sanity checks evaluated before deployment, exposed to the CLI.";
          };
