...
def remove_machine(
    ...
    commit_files(
        removed_paths,
        flake_dir,
        f"secrets: Removed machine {name}",
    )
...
def add_secret(
    ...
    commit_files(
        paths,
        flake_dir,
        f"vars: Added {machine} to secret {secret_path.relative_to(clan_dir)}",
    )
...
def remove_secret(
    ...
    commit_files(
        updated_paths,
        flake_dir,
        f"vars: Removed {machine} from secret {secret}",
    )
