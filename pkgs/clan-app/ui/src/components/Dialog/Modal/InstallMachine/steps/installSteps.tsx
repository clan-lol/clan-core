...
export const ConfigureAddress = (props: {
  ...
  return (
    <Form
      ...
      class="flex h-[30rem] w-svw max-w-3xl flex-col"
    >
...
const CheckHardware = () => {
  ...
  return (
    <div class="flex h-[30rem] w-svw max-w-3xl flex-col">
      <ModalHeading text={`Installing: ${machine().id}`} />
      <div class="flex-1 p-4">
        <StepLayout
          body={
...
export const ConfigureData = () => {
  ...
  return (
    <>
      <Suspense
        fallback={
          <div class="relative flex h-[30rem] w-svw max-w-3xl items-center justify-center">
