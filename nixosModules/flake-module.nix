    ...
    }:
    {
      ...
      config = {
        clan.core.clanPkgs = lib.mkDefault {
          zerotier-members = pkgs.callPackage (self + "clanServices/zerotier/pkgs/zerotier-tools") { };
          zerotierone = pkgs.callPackage (self + "clanServices/zerotier/pkgs/zerotierone") { };
        };
      };
    };
in
